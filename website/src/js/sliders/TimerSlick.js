...
class TimerSlick extends StandardSlick {
    ...
    preInit() {
        // Set the CSS animation duration for the timer progress bar based on the Slick speed settings
        this.sliderTimerProgress.style.animationDuration = ((parseInt(this.slickSettings.autoplaySpeed) + parseInt(this.slickSettings.speed)) / 1000) + 's';
